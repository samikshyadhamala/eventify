        ...
        <>
            <footer>
                <div className="footer-content text-white">
                    <div className="footer-section flex-col gap-2">
                        <p className="Footer-About text-justify">
                ...
                <i className="fa-brands fa-youtube" id="youtube"></i> */}
                    ...
                    <div className="footer-nav">
                        <div className="footer-contact">
                            <h3>User</h3>
                            <div>
                                <p><a href="#" className='text-white'>User SignIn</a></p>
                                <p><a href="#" className='text-white'>User Login</a></p>
                            </div>
                        </div>
                        ...
                        <div className="footer-contact">
                            <h3>Club</h3>
                            <div>
                                <p><a href="Club Sign In.html" className="text-white">Club SignIn</a></p>
                                <p><a href="#" className="text-white">Club Lo   gin</a></p>
                                <p><a href="#" className="text-white">Create Event</a></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="footer-contact">
                        ...
                        <p>Email: <a href="mailto:eventify@gmail.com" className='text-white'>eventify@gmail.com</a></p>
